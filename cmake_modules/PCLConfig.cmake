...
set(PCL_DIR "/home/jose/pcl-pcl-1.8.1/PCLConfig.cmake")
...
macro(find_qhull)
  ...
  elseif(NOT QHULL_ROOT)
    get_filename_component(QHULL_ROOT "QHULL_INCLUDE_DIR-NOTFOUND" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/cmake/vtk-7.1" CACHE PATH "The directory containing VTKConfig.cmake")
    else()
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-7.1" CACHE PATH "The directory containing VTKConfig.cmake")
    endif()
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/local/lib/cmake/vtk-7.1" CACHE PATH "The directory containing VTKConfig.cmake")
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/jose/pcl-pcl-1.8.1")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters 2d features keypoints geometry ml segmentation visualization outofcore stereo people surface registration recognition tracking )
